	...
	<div class='wrapper'>
					...
					<ul class='nav navbar-nav'>
						...
						<li class='dropdown user user-menu'>
							...
							<ul class='dropdown-menu'>
								<li class='user-header' style="background-color: red;">
									<?php
		...
		<aside class='main-sidebar' style="background-color:white">
			...
			<div class="menu-header">
				<ul>
					<li>
						<a style="color:yellow" href="." class="btn-logout">
							<span class="fa fa-home fa-2x"></span><br>Dashboard
						</a>
					</li>
					<li>
						<a style="color:yellow" class="btn-logout" href="?pg=pengaturan">
							<span class="fa fa-user-cog fa-2x"></span><br>Pengaturan
						</a>
					</li>
					<li>
						<a style="color:red" href="logout.php" class="btn-logout"> <span class="fa fa-sign-out-alt fa-2x"></span><br>Keluar</a>
					</li>
				</ul>
			</div>
		...
		<footer class='main-footer hidden-xs'>
			<div class='container'>
				<div class='pull-left hidden-xs'>
					<strong>
						<span id='end-sidebar'>
							&copy; Dinas Pendidikan dan Kebudayaan Kabupaten Konawe
						</span>
					</strong>
				</div>
